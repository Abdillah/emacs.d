...
(deftheme codelatte "Custom theme configured for personal-use")
...
(let ((*background-color*  "#f8f8ff")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-keyword-face ((t (:bold t :weight bold :foreground "#0086b3"))))
   ...
   `(font-lock-variable-name-face ((t (:foreground "#a0a"))))
   ...
   `(region ((t (:background "#ccc" :foreground nil))))
   `(cursor ((t (:background "#444"))))
   `(show-paren-match ((t (:background "#fff6a9"))))
   `(show-paren-mismatch ((t (:background "#dd1144"))))))

(provide-theme 'codelatte)

;;; color-theme-codelatte.el ends here
